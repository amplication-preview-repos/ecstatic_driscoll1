...
@InputType()
class GeneUpdateInput {
  @ApiProperty({
    required: false,
    type: () => ExpressionDataUpdateManyWithoutGenesInput,
  })
  @ValidateNested()
  @Type(() => ExpressionDataUpdateManyWithoutGenesInput)
  @IsOptional()
  @Field(() => ExpressionDataUpdateManyWithoutGenesInput, {
    nullable: true,
  })
...
export { GeneUpdateInput as GeneUpdateInput };

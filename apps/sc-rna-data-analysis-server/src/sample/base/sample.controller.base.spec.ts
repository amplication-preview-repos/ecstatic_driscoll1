...
describe("Sample", () => {
  ...
  test("POST /samples", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        collectionDate: CREATE_RESULT.collectionDate.toISOString(),
  ...
  test("GET /samples", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          collectionDate: FIND_MANY_RESULT[0].collectionDate.toISOString(),
  ...
  test("GET /samples/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        collectionDate: FIND_ONE_RESULT.collectionDate.toISOString(),
